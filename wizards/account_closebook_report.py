...
class AccountCloseBookReport(models.TransientModel):
    _name = "account.closebook.report"
    _description = "Close Book Report"
    ...
    account_ids = fields.Many2many('account.account', 'account_account_closebook_report', 'report_line_id',
